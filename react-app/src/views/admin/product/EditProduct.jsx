...
export default function EditProduct() {
   ...
   useEffect(() => {
      ...
      axios.get(`/api/admin/edit-product/${product_id.id}`).then(res => {
   ...
   const updateProduct = (e) => {
      ...
      axios.post(`/api/admin/update-product/${product_id.id}`, data).then(res => {
                        ...
                        <div className='tab-pane card-body fade' id='other-details' role='tabpanel' aria-labelledby='other-details-tab' tabindex='0'>
                           <div className='row'>
                              ...
                              <div className='row align-items-center justify-content-center mb-3'>
                                 <img src={`http://localhost:8000/${product.image}`} className='col-md-3 rounded-2 mb-3' width='50px' />

                                 <div className='col-md-9 form-group'>
                                    <input type='file' name='image' onChange={handleImage} className='form-control bg-dark text-light' />
